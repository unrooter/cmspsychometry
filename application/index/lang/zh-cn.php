...
return [
    ...
    // 测试记录
    'My Test Records'                                        => '我的测试记录',
    'Fun Test Records'                                       => '趣味测试记录',
    'Test Time'                                              => '测试时间',
    'View Results'                                           => '查看结果',
    ...
    // 底部链接
    'Platform Description'                                   => '自我孵化心理测试平台是一个集合各种专业的心理估量表以及趣味测试的平台，致力于为用户提供高质量、专业且有趣的在线心理测试服务。通过这些测试，希望你能够在不同的角度更加了解自我。',
    'About Us'                                               => '关于我们',
    'User Agreement'                                         => '用户协议',
