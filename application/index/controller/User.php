...
class User extends Frontend
{
    ...
    public function register()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $mbti = $this->request->post('mbti', '');
            $enneagram = $this->request->post('enneagram', '');
...
//            }
            ...
            $extend['mbti'] = $mbti;
            $extend['enneagram'] = $enneagram;
            if ($this->auth->register($username, $password, $email, $mobile,$extend)) {
                $this->success(__('Sign up successful'), $url ? $url : url('user/index'), ['token' => $this->request->token()]);
            } else {
    ...
    public function login()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($this->auth->login($account, $password)) {
                $this->success(__('Logged in successful'), $url ? $url : url('user/index'), ['token' => $this->request->token()]);
            } else {
                $this->error($this->auth->getError(), null, ['token' => $this->request->token()]);
            }
        }
