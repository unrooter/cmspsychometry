...
return [
    ...
    [
        ...
        'type' => 'image',
        'content' => [],
        'value' => '/uploads/20240228/3628987c7109929dd29a9968921ac020.png',
        'rule' => 'required',
        'msg' => '',
    ...
    [
        ...
        'type' => 'string',
        'content' => [],
        'value' => '自我孵化心理-免费在线心理测试，有MBTI人格类型、九型人格、职业兴趣、行为风格、大五人格、职业规划、爱情婚姻、抑郁症等多方面测试',
        'rule' => '',
        'msg' => '',
        'tip' => '',
        'ok' => '',
    ...
    [
        ...
        'type' => 'string',
        'content' => [],
        'value' => '免费在线心理测试,免费心理测试,MBTI,人格测试,免费',
        'rule' => '',
        'msg' => '',
        'tip' => '',
        'ok' => '',
    ...
    [
        ...
        'type' => 'string',
        'content' => [],
        'value' => '自我孵化心理是一个专业的在线心理测试平台，提供高质量、有趣的免费测试服务和干货文章，帮助你深入了解自己，解决心理困扰，实现心理健康和自我发展。涵盖MBTI人格类型、九型人格、职业兴趣、行为风格、大五人格、职业规划、爱情婚姻、抑郁症等多方面测试。建立正确心理观念，获得更多幸福感和成就感。',
        'rule' => '',
        'msg' => '',
        'tip' => '',
        'ok' => '',
